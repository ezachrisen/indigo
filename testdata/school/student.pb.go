...
type StudentSummary struct {
	...
	RiskFactor float64            `protobuf:"fixed64,2,opt,name=RiskFactor,proto3" json:"RiskFactor,omitempty"`
...
func (x *StudentSummary) Reset() {
	*x = StudentSummary{}
	if protoimpl.UnsafeEnabled {
		mi := &file_testdata_proto_student_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*StudentSummary) Descriptor() ([]byte, []int) {
	return file_testdata_proto_student_proto_rawDescGZIP(), []int{1}
}
...
func (x *Student_Suspension) Reset() {
	*x = Student_Suspension{}
	if protoimpl.UnsafeEnabled {
		mi := &file_testdata_proto_student_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
var file_testdata_proto_student_proto_rawDesc = []byte{
	...
	0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xa6, 0x04, 0x0a, 0x07, 0x53, 0x74, 0x75, 0x64,
	...
	,
...
var file_testdata_proto_student_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_testdata_proto_student_proto_goTypes = []interface{}{
	...
	(*StudentSummary)(nil),      // 2: school.StudentSummary
	nil,                         // 3: school.Student.AttrsEntry
	(*Student_Suspension)(nil),  // 4: school.Student.Suspension
...
var file_testdata_proto_student_proto_depIdxs = []int32{
	...
	5, // 1: school.Student.EnrollmentDate:type_name -> google.protobuf.Timestamp
	3, // 2: school.Student.Attrs:type_name -> school.Student.AttrsEntry
	4, // 3: school.Student.XYZ:type_name -> school.Student.Suspension
	4, // 4: school.Student.Suspensions:type_name -> school.Student.Suspension
	6, // 5: school.StudentSummary.Tenure:type_name -> google.protobuf.Duration
	5, // 6: school.Student.Suspension.Date:type_name -> google.protobuf.Timestamp
...
func file_testdata_proto_student_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_testdata_proto_student_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_testdata_proto_student_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
